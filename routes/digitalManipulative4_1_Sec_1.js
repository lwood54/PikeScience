...
router.get('/', function(req, res, next) {
  res.render('digitalManipulative', {
    ...
    col1Def: "Organisms better suited to their environment tend to survive & pass on their genes.",
    col2Heading: 'Adaptation',
    col2Img: '/images/adaptationGif.gif',
    col2Hint: "Birds now have hollow bones that enable flight, humans walk on 2 feet, snakes have venom.",
    ...
    col3Hint: "Your pet dog is no longer like a wolf, but has the traits that were chosen by a breeder.",
    col3Def: "Humans select the genes for our purposes and choose which individuals will reproduce.",
    col4Heading: 'Gills',
    col4Img: "/images/gillsGif.gif",
    col4Hint: "Found in fish and sharks internally, but even some salamanders have these externally.",
    ...
    col5Hint: "Functions in a similar manner to blood vessels in people.",
